...
class Trainer:
    def __init__(self, args, cfg, device):
        ...
        self.loss_info = ['Epoch', 'lr', 'iou_loss', 'dfl_loss', 'cls_loss'] + (['gtg_loss', 'sga_loss'] if args.enable_gater_net else [])
    ...
    def train_in_steps(self, epoch_num, step_num):
        ...
        with amp.autocast(enabled=self.device != 'cpu'):
            ...
            preds, gates, s_featmaps, subgroups = self.model(images)
            ...
            if self.args.distill:
                ...
                total_loss, loss_items = self.compute_loss(preds, targets, epoch_num, step_num, 1.0, gates, subgroups) # YOLOv6_af
    ...
    def get_data_loader(self, args, cfg, data_dict):
        ...
        train_loader = create_dataloader(train_path, args.img_size, args.batch_size // args.world_size, grid_size,
                                         ...
                                         strides=cfg.model.head.strides, cache_ram=args.cache_ram)[0]

...
RUN apt-get update && \
    ...
    wget https://github.com/Kitware/CMake/releases/download/v3.22.0/cmake-3.22.0-Linux-aarch64.tar.gz --no-check-certificate && \
...
# Set the work directory and copy the files there
WORKDIR /root
...
RUN apt-get install -y libopenblas-base libopenmpi-dev libomp-dev libjpeg-dev zlib1g-dev libpython3-dev libopenblas-dev libavcodec-dev libavformat-dev libswscale-dev
